...
<!-- InstanceBeginEditable name="DocTitle" --><title>Perfect Sync Downloads</title><!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="Body" -->
    <p align="center" class="Tiny"><img src="/rt/Dingbats/Divider.A.512.gif" width="512" height="8"  /><br />
      <br />
      <img src="/rt/DevTools/Downloads_x32.gif" alt="Downloads" width="158" height="32" />      <br />
      <br />  
      <img src="/rt/Dingbats/Divider.Z.512.gif" width="512" height="8"  /></p>
    <p align="center" class="TopicHeader1">DOCUMENTATION</p>
    <p align="center"><a href="/dl/SQLToolsCHM.zip">SQL Tools Version 3 - CHM</a><br />
      <a href="/dl/SQLToolsHLP.zip">SQL Tools Version 3 - HLP</a><br />
        <a href="/dl/SQLToolsPDF.pdf">SQL Tools Version 3 - PDF</a><br />
    <a href="../../dl/SQLToolsV2.pdf" class="Tiny">SQL Tools Version 2 - PDF </a></p>
    <p align="center"><a href="/dl/GfxTools.pdf">Graphics Tools Version 2 - PDF</a></p>
    <p align="center"><a href="/dl/ConTools.pdf">Console Tools Version 2 - PDF</a></p>
    <p align="center" class="TopicHeader1">PRODUCT UPDATES </p>
    <p align="center">Please check your product's version number against the<br />
<a href="/pp/DevTools/CurrentVersions.php">Current Version Number</a> 
    before you request an update.</p>
  <!-- InstanceEndEditable -->
</div>
